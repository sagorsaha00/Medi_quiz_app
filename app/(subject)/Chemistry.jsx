...
export default function App() {
  ...
  const cardsStyle = useAnimatedStyle(() => ({
    ...
    transform: [{ translateY: interpolate(cardsEntrance.value, [0, 1], [20, 0]) }],
  }));
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
          <View style={styles.searchRow}>
            ...
            >
              ...
              <TextInput placeholder=' Search courses, quizzes...' style={[styles.searchText, { color: '#9CA3AF' }]}>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text
                    style={[
                      styles.cardTitle,
                      theme === 'dark' ? { color: '#EDEDED' } : { color: '#111827' },
                    ]}
                  >
                    {s.title}
                  </Text>
                  <Text
                    style={[
                      styles.cardSubtitle,
                      theme === 'dark' ? { color: '#9CA3AF' } : { color: '#6B7280' },
                    ]}
                  >
                    {s.subtitle}
                  </Text>
